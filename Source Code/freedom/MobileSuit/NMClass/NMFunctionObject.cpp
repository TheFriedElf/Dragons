...
CNMP2PMultiSendDataFunc::CNMP2PMultiSendDataFunc( NMP2PKey const & sender, NMP2PKey const * receivers, UINT32 receiversSize, BYTE const * data, UINT32 dataSize, UINT32 ttl )
	...
	, uP2PSerialKey( 0 )
	, sender( sender )
	, receiversSize( receiversSize )
	, dataSize( dataSize )
	, ttl( ttl )
{
	::CopyMemory( this->receivers, receivers, __min( this->receiversSize, P2PRECEIVERS_SIZE ) * sizeof( NMP2PKey ) );
...
CNMSendReportMsgFunc::CNMSendReportMsgFunc( CNMReportInfo::NMREPORTTYPE uType, CNMReportInfo::NMREPORTSUBTYPE uSubType, LPCTSTR szTargetNickname, LPCTSTR szReason, LPCTSTR szEvidence, _UInt32_ uGameCode, _UInt32_ uAppliedGameCode )
	: CNMFunc( kCode, 1 )
{
...
CNMLoginAuthFunc::CNMLoginAuthFunc( LPCTSTR pszNexonID, LPCTSTR pszPassword, INT32 nRegionCode, LPCTSTR pszMID )
: CNMFunc( kCode, 1 )
{
	this->uLoginType		= kLoginType_IDPassword;
	this->szPassport[0]		= 0;
